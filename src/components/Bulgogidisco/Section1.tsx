...
export const Section1 = () => {
  const IMG_SRC = [
    '/images/bulgogi/1.png',
    '/images/bulgogi/2.png',
    '/images/bulgogi/3.png',
    '/images/bulgogi/4.png',
  ];
  return (
    <Wrapper direction='column' align='center' justify='flex-start'>
      ...
      >
        <Interview
          title={interviewData.interview1.question}
          description={interviewData.interview1.answer}
        />
        <Interview
          title={interviewData.interview2.question}
          description={interviewData.interview2.answer}
        />
      </Flex>
      <Space height={84.16} />
      <Flex
        className='interview2'
        gap={5}
        direction='column'
        justify='flex-start'
      >
