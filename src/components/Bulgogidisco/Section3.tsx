...
export const Section3 = () => {
  const IMG_SRC = [
    '/images/bulgogi/10.png',
    '/images/bulgogi/11.png',
    '/images/bulgogi/12.png',
  ];
  ...
  return (
    <Wrapper direction='column' align='center' justify='flex-start'>
      ...
      <Space height={157.08} />
      <Flex
        className='section3-interview1'
        direction='column'
        justify='flex-start'
      >
        <Interview
          title={interviewData.interview11.question}
          description={interviewData.interview11.answer}
        />
      </Flex>
      <ImageWrapper>
        <Interview
