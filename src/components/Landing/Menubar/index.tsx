...
import {
  ...
  Text,
  VerticalLine,
} from '@break/components/common/common';
...
export const Menubar = (props: MenubarProps) => {
  ...
  const handleArticleHover = () => {
    ...
    setCurrentImage([
      IMG_SRC.article[selectedIndices[0]],
      IMG_SRC.article[selectedIndices[1]],
    ]);
  };
  const handleBulgogidiscoHover = () => {
    ...
    setCurrentImage([
      IMG_SRC.bulgogidisco[selectedIndices[0]],
      IMG_SRC.bulgogidisco[selectedIndices[1]],
    ]);
  };
      ...
      <MenubarContent>
        ...
        <Content direction='column' align='flex-start' justify='flex-start'>
          ...
          <Text
            ...
            onMouseOver={() => handleBulgogidiscoHover()}
          >
            계속 뭉그적거리고만 있을 수는 없잖아. 불살라 버리는 거야. 모두 함께
            춤을 추자!
            <br />
